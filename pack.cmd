...
"7-zip-24.05\7za.exe" a -sccUTF-8 -scsUTF-8 -tzip -y "output\BFMod CNTR Project.zip" @file-list\all.txt
"7-zip-24.05\7za.exe" rn -sccUTF-8 -scsUTF-8 -tzip -y "output\BFMod CNTR Project.zip" "assets\bf\font\bold-all.json" "assets\bf\font\bold.json"
"7-zip-24.05\7za.exe" rn -sccUTF-8 -scsUTF-8 -tzip -y "output\BFMod CNTR Project.zip" "pack-all.mcmeta" "pack.mcmeta"
"7-zip-24.05\7za.exe" rn -sccUTF-8 -scsUTF-8 -tzip -y "output\BFMod CNTR Project.zip" "pack-all.png" "pack.png"
